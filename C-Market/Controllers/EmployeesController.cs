...
namespace C_Market.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeID,FirstName,LastName,Salaray,BonusPercent,DateOfBrith,StartTime,Email,URL,MyProperty,DocumentTypeID")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeID,FirstName,LastName,Salaray,BonusPercent,DateOfBrith,StartTime,Email,URL,MyProperty,DocumentTypeID")] Employee employee)
        {
            if (ModelState.IsValid)
            {
